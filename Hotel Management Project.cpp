...
void display_all_customer(int r_number){
...
void main_menu(){
	...
	for(;;)
	{
		...
		cout<<"\n\t\tPress 2 to DIAPLAY ALL ROOMS ALLOTTED";
		cout<<"\n\t\tPress 3 to DISPLAY SPECIFIC CUSTOMER RECORD";
		cout<<"n\t\tPress 4 to MODIFY CUSTOMER RECORD";
		cout<<"\n\t\tPress 5 to DISPLAY CUSTOMER RECORD";
		cout<<"\n\t\tPress 6 to Exit";
cout<<"\n\t\tOption:";
cin>>option;
switch(option)
{
	   ...
	   system("cls");
	       break;
	   case 2:void display_all_customer(int r_number);
	   system("cls");
	       break;
	  case 3: 
	        int r_number;
